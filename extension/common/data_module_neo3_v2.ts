...
// Defined in cross-runtime so the confirmation windows report the same codes
// the injected dAPI hands back to dApps.
export { NEP21ErrorCode, NEP21Error } from '../../cross-runtime/neo-dapi-error';
