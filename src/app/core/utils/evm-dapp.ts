 ...
 * These are the parsed tokenId values returned by `parseStandardTokenTransactionData`, whose
 * ERC721 and ERC1155 ABIs are the standard ones bundled in `@popup/_lib`.
 *
 * @param {object} tokenData - ethers Interface token data.
 * @returns {string | undefined} A decimal string value.
 */
