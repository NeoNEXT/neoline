...
import { PopupLogoutDialogComponent } from './popup/_dialogs/logout/logout.dialog';
...
export class AppComponent implements OnDestroy{
    ...
    public close() {
        this.dialog.open(LogoutDialog, { panelClass: 'custom-dialog-container' }).afterClosed().subscribe((confirm) => {
            if (confirm) {
