...
export class PopupPickAddressComponent implements OnInit {
    ...
    constructor(
        ...
        const storageName = this.tabType === 'Neo3' ? STORAGE_NAME['walletArr-Neo3'] : STORAGE_NAME.walletArr;
        this.chrome.getStorage(storageName).subscribe(walletArr => this.walletArr = walletArr || []);
    }
