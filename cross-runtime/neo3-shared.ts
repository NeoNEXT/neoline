...
export enum requestTargetN3 {
  ...
  BlockCount = 'neoline.target_block_count_n3',
  ...
  Authenticate = 'neoline.target_authenticate_n3',
  ...
  CreateTransaction = 'neoline.target_create_transaction_n3',
  Relay = 'neoline.target_relay_n3',
